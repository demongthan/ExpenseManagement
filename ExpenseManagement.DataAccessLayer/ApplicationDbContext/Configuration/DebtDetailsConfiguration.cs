...
{
    public class DebtDetailsConfiguration : IEntityTypeConfiguration<DebtDetails>
    {
        public void Configure(EntityTypeBuilder<DebtDetails> builder)
        {
            ...
            builder.Property(_ => _.IsPay)
                .HasColumnType("bit")
                .HasDefaultValue(false);

            builder.Property(_ => _.DatePay)
                .HasColumnType("datetime2(7)");

            builder.Property(_ => _.Type)
                .HasColumnType("tinyint")
                .HasDefaultValue(TypeDebt.Credit);
